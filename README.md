...
- 🖥️ Deepening my knowledge of **Computer Science** fundamentals at university
- 🔌 Exploring **embedded systems** and low-level programming
- 🛠️ Getting better at **PCB design** and **3D modeling/printing**
- 📐 Experimenting with mechatronics projects in my spare time

---

🌱 Interests
`Full Stack Dev` `Game Dev` `Electronics` `PCB Design` `3D Modeling & Graphics` `Embedded Systems` `Robotics`
